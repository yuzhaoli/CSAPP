...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL,
	  IOPL, IJXX, ICALL, IRET, IPUSHL, IPOPL, IIADDL, ILEAVE, ITESTSET };
...
bool need_regids =
	f_icode in { IRRMOVL, IOPL, IPUSHL, IPOPL, 
		     IIRMOVL, IRMMOVL, IMRMOVL,ITESTSET, IIADDL };

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL,ITESTSET, IJXX, ICALL, IIADDL };
...
int d_srcB = [
	D_icode in { IOPL, IRMMOVL, IMRMOVL,ITESTSET, IIADDL  } : D_rB;
...
int d_dstM = [
	D_icode in { IMRMOVL,ITESTSET, IPOPL } : D_rA;
	D_icode in {ILEAVE} : REBP;
	1 : RNONE;  # Don't write any register
];
...
int aluA = [
	...
	E_icode in { IIRMOVL, IRMMOVL, IMRMOVL,ITESTSET, IIADDL } : E_valC;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL,ITESTSET, IOPL, ICALL, 
...
int mem_addr = [
	M_icode in { IRMMOVL, IPUSHL, ICALL, IMRMOVL,ITESTSET } : M_valE;
	M_icode in { IPOPL, IRET, ILEAVE } : M_valA;
	# Other instructions don't need address
];

## Set read control signal
bool mem_read = M_icode in { IMRMOVL,ITESTSET, IPOPL, IRET, ILEAVE };

## Set write control signal
bool mem_write = M_icode in { IRMMOVL, IPUSHL, ICALL, ITESTSET};
...
bool F_stall =
	...
	E_icode in { IMRMOVL,ITESTSET, IPOPL, ILEAVE } &&
	 E_dstM in { d_srcA, d_srcB } ||
	# similar hazard for LEAVE
...
bool D_bubble =
	...
	!(E_icode in { IMRMOVL,ITESTSET, IPOPL, ILEAVE } && E_dstM in { d_srcA, d_srcB }) &&
	  IRET in { D_icode, E_icode, M_icode };
